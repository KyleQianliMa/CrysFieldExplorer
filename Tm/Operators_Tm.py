...
def solver(B20,B40,B43,B60,B63,B66):
 ...
 scattering1=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,1],jx,jy,jz)
 scattering2=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,2],jx,jy,jz)
 scattering3=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,3],jx,jy,jz)
 scattering4=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,4],jx,jy,jz)
 scattering5=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,5],jx,jy,jz)
 scattering6=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,6],jx,jy,jz)
 scattering7=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,7],jx,jy,jz)
 scattering8=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,8],jx,jy,jz)
 scattering9=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,9],jx,jy,jz)
 scattering10=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,10],jx,jy,jz)
 scattering11=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,11],jx,jy,jz)
 scattering12=scattering(np.transpose(np.conj(Eigenvectors[:,0])),Eigenvectors[:,12],jx,jy,jz)
 ...
 N=scattering1 #Subject to change on relative intensity
 s1=scattering1/N
 s2=scattering2/N
 s3=scattering3/N
 s4=scattering4/N
 ...
 return np.array([s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12]).squeeze(), Energy, Eigenvectors,jx,jy,jz, HH
